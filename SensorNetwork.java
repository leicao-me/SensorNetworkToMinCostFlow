...
public class SensorNetwork {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Enter the width: (e.g.15)");
//		double width = scan.nextDouble();
        double width = 15;

		System.out.println("Enter the height: (e.g.15)");
//		double height = scan.nextDouble();
        double height = 15;

		System.out.println("Enter the number of nodes: (e.g.6)");
...
//		int transmissionRange = scan.nextInt();
		...
		System.out.println("How many DGs(Data Generators)? (e.g.2)");
//		int numberOfDG = scan.nextInt();
        int numberOfDG = 2;

		dataGens = new int[numberOfDG];
		System.out.println("Assuming the first " + numberOfDG + " nodes are DGs, since all nodes are randomly made\n");
...
//		int numberOfDataItemsPerDG = scan.nextInt();
        ...
        System.out.println("Capacity Random Range per node up from the min capacity:(e.g.5)");
